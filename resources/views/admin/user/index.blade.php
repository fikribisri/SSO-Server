    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <i class="fa fa-users"></i> List User <a href="{{ route('admin.user.create') }}" class="btn btn-sm btn-pill btn-success float-right text-white"><i class="fa fa-plus"></i> Create User</a>
            </div>
