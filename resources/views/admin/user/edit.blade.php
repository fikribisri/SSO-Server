...
<div class="container-fluid">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header"><i class="fa fa-users"></i> Edit User</div>
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.user.update', $model->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="form-group row">
                                <label for="email_secondary" class="col-md-4 col-form-label text-md-right">{{ __('Email Secondary') }} <span style="color:red">*</span></label>

                                <div class="col-md-6">
                                    <input id="email_secondary" type="email" class="form-control @error('email_secondary') is-invalid @enderror" name="email_secondary" value="{{ $model->email_secondary }}" required autocomplete="email_secondary" autofocus>
